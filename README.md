...
| チャット機能         | チャットルーム(スレッド)立ち上げ                                    | ログインした人がルームを立ち上げることができ、メンバーを選別できる。             | ・「チャンネル作成」ボタンを押すと新規チャンネル作成画面に遷移・チャンネル名とメンバー1人を選別して登録する・「チャンネル終了」ボタンでチャンネルを削除することができる |
| メッセージ投稿機能    | メッセージ投稿 | ログインした人であればメッセージ投稿が可能                                  | ・メッセージを入力して送信ボタンを押すと投稿できる・任意で画像を投稿する事も可能 |
| チャンネル編集機能 | 立ち上げたチャットルームの情報を更新する                             | ルームを立ち上げたメンバーが編集できる                                      | ・立ち上げたチャットルームの情報を間違えた際に「チャンネル編集」ボタンを押す事でチャンネル名とメンバーを変更できる・すでにメッセージが投稿されていれば自動的に削除される |
...
| 保留リスト機能        | 保留リストを表示する | ・ログインした人が投稿にある保留ボタンを押すと保留リストに表示される | ・1つ1つの投稿に保留ボタンが配置されている・保留ボタンを押すと、該当する投稿内容が保留リストに表示される |
